...
const DB_USER = 'dialyzeease';
const DB_PASSWORD = 'D91lyz5_E1s5'
const DB_NAME = 'dialyzeease';

// Path to schema file
const schemaFilePath = path.join(__dirname, 'dialyzeease_db_schema_v1.8.sql');
