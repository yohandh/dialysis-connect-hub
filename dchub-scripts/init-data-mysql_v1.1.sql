-- MySQL initialization script for Dialysis Connect Hub
...
(1000, 1000, 'Admin', 'User', 'admin@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '011-242-2335', 1, '2023-06-20 07:15:00'),
(1001, 1000, 'Suwan', 'Rathnayake', 'suwan@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '077-912-4893', 1, '2023-06-19 10:30:00'),
(1002, 1000, 'Yohan', 'Hirimuthugoda', 'yohan@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '077-727-8874', 1, '2023-06-18 14:45:00');

-- Staff users
INSERT INTO users (id, role_id, first_name, last_name, email, password, mobile_no, is_active, last_login_at) VALUES
(1003, 1001, 'Suwan', 'Rathnayake', 'suwan.rathnayake@gmail.com', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '077-912-4893', 1, '2025-04-05 08:30:00'),
(1004, 1001, 'Yohan', 'Hirimuthugoda', 'yohandh@gmail.com', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '077-727-8824', 1, '2025-04-04 10:45:00');

-- Centers
INSERT INTO centers (id, name, address, contact_no, email, total_capacity) VALUES
(1, 'The National Institute For Nephrology Dialysis & Transplantation', 'Colombo', '011-200-0000', 'thenationalinstitutefornephrologydialysistransplantation@dialysis.org', 10),
(2, 'Nawaloka', 'Colombo', '011-200-0001', 'nawaloka@dialysis.org', 10),
(3, 'Asiri Surgical', 'Colombo', '011-200-0002', 'asirisurgical@dialysis.org', 10),
(4, 'Kings Hospital', 'Colombo', '011-200-0003', 'kingshospital@dialysis.org', 10),
(5, 'Lanka Hospital', 'Colombo', '011-200-0004', 'lankahospital@dialysis.org', 10);

-- Beds
INSERT INTO beds (id, center_id, code) VALUES
(1, 1, 'BED-1-01'),
(2, 1, 'BED-1-02'),
(3, 1, 'BED-1-03'),
(4, 1, 'BED-1-04'),
...
-- Sessions
INSERT INTO sessions (id, center_id, weekday, start_time, end_time, default_capacity, created_by_id) VALUES
(1, 1, 'mon', '08:00:00', '10:00:00', 10, 1000),
(2, 1, 'mon', '12:00:00', '14:00:00', 10, 1000),
(3, 1, 'mon', '16:00:00', '18:00:00', 10, 1000),
(4, 2, 'mon', '08:00:00', '10:00:00', 10, 1000),
(5, 2, 'mon', '12:00:00', '14:00:00', 10, 1000),
(6, 2, 'mon', '16:00:00', '18:00:00', 10, 1000),
(7, 3, 'mon', '08:00:00', '10:00:00', 10, 1000),
(8, 3, 'mon', '12:00:00', '14:00:00', 10, 1000),
(9, 3, 'mon', '16:00:00', '18:00:00', 10, 1000),
(10, 4, 'mon', '08:00:00', '10:00:00', 10, 1000),
(11, 4, 'mon', '12:00:00', '14:00:00', 10, 1000),
(12, 4, 'mon', '16:00:00', '18:00:00', 10, 1000),
(13, 5, 'mon', '08:00:00', '10:00:00', 10, 1000),
(14, 5, 'mon', '12:00:00', '14:00:00', 10, 1000),
(15, 5, 'mon', '16:00:00', '18:00:00', 10, 1000);

-- Schedule Sessions
INSERT INTO schedule_sessions (id, center_id, session_id, session_date, start_time, end_time, available_beds, created_by_id) VALUES
(1, 1, 1, '2025-04-14', '08:00:00', '10:00:00', 10, 1000),
(2, 1, 2, '2025-04-14', '12:00:00', '14:00:00', 10, 1000),
(3, 1, 3, '2025-04-14', '16:00:00', '18:00:00', 10, 1000),
(4, 2, 4, '2025-04-14', '08:00:00', '10:00:00', 10, 1000),
(5, 2, 5, '2025-04-14', '12:00:00', '14:00:00', 10, 1000),
(6, 2, 6, '2025-04-14', '16:00:00', '18:00:00', 10, 1000),
(7, 3, 7, '2025-04-14', '08:00:00', '10:00:00', 10, 1000),
(8, 3, 8, '2025-04-14', '12:00:00', '14:00:00', 10, 1000),
(9, 3, 9, '2025-04-14', '16:00:00', '18:00:00', 10, 1000),
(10, 4, 10, '2025-04-14', '08:00:00', '10:00:00', 10, 1000),
(11, 4, 11, '2025-04-14', '12:00:00', '14:00:00', 10, 1000),
(12, 4, 12, '2025-04-14', '16:00:00', '18:00:00', 10, 1000),
(13, 5, 13, '2025-04-14', '08:00:00', '10:00:00', 10, 1000),
(14, 5, 14, '2025-04-14', '12:00:00', '14:00:00', 10, 1000),
(15, 5, 15, '2025-04-14', '16:00:00', '18:00:00', 10, 1000);
...
-- Center hours
-- Weekdays: 6 AM – 6 PM
-- Saturday: 8 AM – 4 PM (custom)
-- Sunday: Closed

-- Operating hours for Center 1
INSERT INTO center_hours (center_id, weekday, open_time, close_time) VALUES
(1, 'mon', '06:00:00', '18:00:00'),
(1, 'tue', '06:00:00', '18:00:00'),
(1, 'wed', '06:00:00', '18:00:00'),
(1, 'thu', '06:00:00', '18:00:00'),
(1, 'fri', '06:00:00', '18:00:00'),
(1, 'sat', '08:00:00', '16:00:00'),
(1, 'sun', NULL, NULL);

-- Staff/Doctor users
(1003, 1001, 'Sarah', 'Johnson', 'sarah.johnson@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-200-0001', 1, '2023-06-20 08:30:00'),
(1004, 1001, 'David', 'Chen', 'david.chen@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-200-0002', 1, '2023-06-19 10:45:00'),
(1005, 1002, 'Patricia', 'Garcia', 'patricia.garcia@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0001', 1, '2023-06-18 09:15:00'),
(1006, 1002, 'Thomas', 'Brown', 'thomas.brown@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0002', 1, '2023-06-17 16:30:00'),
(1007, 1002, 'Emma', 'Williams', 'emma.williams@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0003', 1, '2023-06-16 11:45:00'),
(1008, 1002, 'Robert', 'Miller', 'robert.miller@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0004', 1, '2023-06-15 14:20:00'),
(1009, 1002, 'James', 'Wilson', 'james.wilson@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0005', 1, '2023-06-14 09:10:00'),
(1010, 1002, 'Linda', 'Martinez', 'linda.martinez@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0006', 1, '2023-06-13 15:30:00'),
(1011, 1002, 'Michael', 'Johnson', 'michael.johnson@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0007', 1, '2023-06-12 10:45:00'),
(1012, 1002, 'Susan', 'Lee', 'susan.lee@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0008', 1, '2023-06-11 13:20:00'),
(1013, 1002, 'Jennifer', 'Adams', 'jennifer.adams@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0009', 1, '2023-06-10 09:15:00'),
(1014, 1002, 'Richard', 'Taylor', 'richard.taylor@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0010', 1, '2023-06-09 14:30:00'),
(1015, 1002, 'Elizabeth', 'Clark', 'elizabeth.clark@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-300-0011', 1, '2023-06-08 11:45:00'),

-- Patient users
(1016, 1003, 'John', 'Smith', 'john.smith@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-400-0001', 1, '2023-06-20 14:30:00'),
(1017, 1003, 'Maria', 'Rodriguez', 'maria.rodriguez@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-400-0002', 1, '2023-06-18 09:45:00'),
(1018, 1003, 'Robert', 'Johnson', 'robert.johnson@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-400-0003', 1, '2023-06-19 16:10:00'),
(1019, 1003, 'Emily', 'Chen', 'emily.chen@dialysisconnecthub.org', '$2b$10$l5Ms/jJcWZHFz62OZoJ84u9w1wsR.hXYQgpWeR0YiiSqXfHnL0ISm', '555-400-0004', 1, '2023-06-17 13:25:00');
