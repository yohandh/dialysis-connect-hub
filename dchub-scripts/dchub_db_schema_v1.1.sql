...
-- SESSIONS (Recurring Weekly Schedule Template)
...
CREATE TABLE schedule_sessions (
  ...
  created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
  FOREIGN KEY (center_id) REFERENCES centers(id) ON DELETE NO ACTION ON UPDATE NO ACTION,
  FOREIGN KEY (session_id) REFERENCES session_templates(id) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
CREATE INDEX idx_beds_center_id ON beds(center_id);
CREATE INDEX idx_appointments_schedule_session_id ON appointments(schedule_session_id);
CREATE INDEX idx_appointments_bed_id ON appointments(bed_id);
CREATE INDEX idx_session_beds_schedule_session_id ON session_beds(schedule_session_id);
